...
export interface User{
	...
	/**	Default Workspace : Link - Workspace - If left empty, the default workspace will be the last visited workspace	*/
	default_workspace?: string
	/**	Default App : Select - Redirect to the selected app after login	*/
	default_app?: string
