...
const CheckoutForm = () => {
  ...
  // const { mutate } = useFrappeGetCall("evcar.api.payment.checkout_with_stripe");
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await fetch(
        "/api/method/evcar.api.payment.checkout_with_stripe",
        {
          method: "POST",
          headers: {
                ...
                <div className="col-lg-5">
                  <div className="your-order-area">
                              ...
                              return (
                                <li key={key}>
                                  <span className="order-middle-left">
                                    {cartItem.item_name} X {cartItem.quantity}
                                  </span>{" "}
                    ...
                    <div className="place-order mt-25">
                      <button className="btn-hover" onClick={onPurchase}>
                        Place Order
                      </button>
                    </div>
                  </div>
